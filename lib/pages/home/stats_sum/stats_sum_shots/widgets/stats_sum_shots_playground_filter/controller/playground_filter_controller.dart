...
import '../../stats_sum_shots_playground/view/controller/stats_sum_shots_playground_controller.dart';
import '../../stats_sum_shots_playground/data/dto/game_action_query_parameters.dart';
import '../dto/game_player_dto.dart';
...
class PlaygroundFilterController extends GetxController {
  ...
  final playgroundC = Get.put(StatsSumShotsPlaygroundController());
