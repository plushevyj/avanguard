...
class _ChartWidget extends StatelessWidget {
  ...
  Widget leftTitleWidgets(double value, TitleMeta _) {
    return Text('${value.toInt()} СМ', style: style, textAlign: TextAlign.left);
  }
          ...
          LineChartData(
            ...
            lineBarsData: [
              ...paramsByYear.entries.map((e) => LineChartBarData(
                    spots: e.value
                        .map((param) =>
                            FlSpot(param.dayFromYear.toDouble(), param.height))
                        .toList(),
                    isCurved: true,
                    color: e.value.any(isAfter)
                        ? StdColors.red
                        : StdColors.red.withOpacity(.6),
                    barWidth: 1,
                      ...
                      getDotPainter: (spot, percent, barData, index) {
                        return FlDotCirclePainter(
                          ...
                          color: e.value.any(isAfter)
                              ...
                              : Colors.transparent,
                          strokeWidth: 1,
                          strokeColor: StdColors.red.withOpacity(.6),
                        );
                      },
                    ),
                    belowBarData: BarAreaData(
                      ...
                      gradient: LinearGradient(
                        ...
                        colors: [
                          const Color(0xFFF6E7E6),
                          const Color(0xFFF6E7E6).withOpacity(0),
                        ],
                      ),
                    ),
                  )),
